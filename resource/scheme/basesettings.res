Scheme
{
	BaseSettings
	{
		...
		Label.DisabledFgColor2			"TransparentWhite5"
		...
		PropertySheet.TextColor			"AccentMain"
		PropertySheet.SelectedTextColor	"AccentMain"
		...
		SectionedListPanel.TextColor		"AccentMain"
